...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  <p>If you didn't expect this or think it's a mistake, please get in touch with us and we'll help you sort it out:</p>
  <div style="background-color: #f0fdf4; border: 1px solid #86efac; border-radius: 8px; padding: 12px; margin: 16px 0;">
    <p style="margin: 4px 0;">📧 <strong>Email:</strong> groovegardenltd@gmail.com</p>
    <p style="margin: 4px 0;">📞 <strong>Phone:</strong> 07464 949485 or 07972 051223</p>
  </div>
      ...
      if (notify && succeeded > 0) {
        try {
          ...
          await sendBookingConfirmationEmail(
            ...
            `⚠️ Your Access Code Has Changed — ${room?.name ?? 'Studio'} | Groove Garden Studios`,
            `Your access code for booking #${booking.id} has been updated. Your old code will no longer work. Please use the new code shown below — you can also view it anytime on your My Bookings page.`
          );
  ...
  app.delete("/api/admin/promo-codes/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      ...
      res.status(500).json({ message: "Error deleting promo code: " + error.message });
    }
  });
